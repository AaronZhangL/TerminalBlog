...
- the phpmailer-fe.php is in the /sample_forms/_lib folder
- the /docs/ folder contains help, tips, strategies, and reserved names
- the /sample_forms/ folder contains an example, external configuration file
  examples, and sample landing pages as well as sample reply emails.
- PLEASE READ THE "changelog.txt" for important information on this version
****************************************************************************
...
A sample form is included.

Installation instructions, tips, help, strategies, and documented reserved words
are in the /doc folder. As of version 3.2.4, we also include a /PHPDocumentor
directory with documentation generated by PHP Documentor.
